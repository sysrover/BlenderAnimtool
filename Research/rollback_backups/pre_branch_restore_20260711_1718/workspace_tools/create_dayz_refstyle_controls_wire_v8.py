...
OUT_BLEND = r"P:\Animation_Weapon\Weapon_template_aks74u_refstyle_controls_wire_v8.blend"
REPORT = os.path.join(ROOT, "anm", "dayz-refstyle-controls-wire-v8-report.json")

EXPORT_ARMATURE = "_DayZ_Character"
RIG = "DAT_DayZ_RefStyleControlsWireV8"
PREFIX = "DAT_REFWIRE8_"
