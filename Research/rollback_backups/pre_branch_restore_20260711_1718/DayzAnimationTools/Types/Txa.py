...
[
	...
	'LeftHandOrigin', 'LeftHandIKTarget', 'LeftHand_Dummy', 'LeftForeArmDirection',
...
[
	...
	'RightForeArmDirectionOrigin' # renamed to "RightForeArmDirectionOrigin" during export
...
class TxaExportSettings:
	...
	def __init__(self):
		...
		self.bConvertToAnm:bool = False
		self.sConverterProject:str = r'C:\Users\sysro\diag\CsharpModVScode\tools\TxaAnmPrototype\TxaAnmPrototype.csproj'
		self.sAnmMode:str = 'optimized'
