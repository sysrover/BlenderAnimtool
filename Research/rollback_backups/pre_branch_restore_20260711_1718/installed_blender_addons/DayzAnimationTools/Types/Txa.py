...
class TxaExportSettings:
	...
	def __init__(self):
		...
		self.bSaveAll:bool = False
		self.bAdditive:bool = False
		self.bSurvivorIK:bool = False
...
class TxaKeyframe:
	...
	def Write(self, fs:StringIO, depth:int = 0):
		...
		if self.HasScale():
			fs.write(f'#t {str(self.scale.GetSwapYZ())}\n')
		fs.write(' ' * (depth + 3))
		fs.write('}\n')
