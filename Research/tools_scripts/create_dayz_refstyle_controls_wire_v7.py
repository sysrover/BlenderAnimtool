...
BASE_BLEND = r"P:\Animation_Weapon\Weapon_template_aks74u_refstyle_controls_plate_v6.blend"
OUT_BLEND = r"P:\Animation_Weapon\Weapon_template_aks74u_refstyle_controls_wire_v7.blend"
REPORT = os.path.join(ROOT, "anm", "dayz-refstyle-controls-wire-v7-report.json")

EXPORT_ARMATURE = "_DayZ_Character"
RIG = "DAT_DayZ_RefStyleControlsWire"
PREFIX = "DAT_REFWIRE_"
...
def create_rig(export):
    ...
    for pb in rig.pose.bones:
        if pb.name.startswith("CTRL_Hand."):
            ...
            pb.custom_shape_scale_xyz = (3.0, 3.0, 3.0)
