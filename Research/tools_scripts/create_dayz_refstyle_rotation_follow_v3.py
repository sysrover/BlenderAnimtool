...
OUT_BLEND = r"P:\Animation_Weapon\Weapon_template_aks74u_refstyle_rotation_follow_v3.blend"
REPORT = os.path.join(ROOT, "anm", "dayz-refstyle-rotation-follow-v3-report.json")

EXPORT_ARMATURE = "_DayZ_Character"
RIG = "DAT_DayZ_RefStyleRotationFollow"
PREFIX = "DAT_REFROT_"
