...
BASE_BLEND = r"P:\Animation_Weapon\Weapon_template_aks74u_refstyle_rotation_follow_v3.blend"
OUT_BLEND = r"P:\Animation_Weapon\Weapon_template_aks74u_refstyle_rotation_tweak_v4.blend"
REPORT = os.path.join(ROOT, "anm", "dayz-refstyle-rotation-tweak-v4-report.json")

EXPORT_ARMATURE = "_DayZ_Character"
RIG = "DAT_DayZ_RefStyleRotationTweak"
PREFIX = "DAT_REFTWEAK_"
...
def create_control_shapes():
    ...
    roll = make_wire_shape(
        "WGT_DAT_Roll_Line",
        [(-0.09, 0, 0), (0.09, 0, 0), (0.065, 0.025, 0), (0.065, -0.025, 0)],
        [(0, 1), (1, 2), (1, 3)],
    )
