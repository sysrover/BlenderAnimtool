...
def main():
    orig_path = pathlib.Path('examples/stand_alerted_original.anm')
    gen_path = pathlib.Path('examples/stand_alerted.anm')
    orig = load(str(orig_path))
    gen = load(str(gen_path))
